...
public class SnowflakeIdGenerator {
    ...
    /**
     * 起始时间戳 (2025-12-17 00:00:00)
     * 可以使用约69年
     */
    private static final long START_TIMESTAMP = 1765933320L;
     ...
     * 构造函数
     */
    public SnowflakeIdGenerator(@Value("${snowflake.datacenter-id}") long datacenterId, @Value("${snowflake.machine-id}") long machineId) {
